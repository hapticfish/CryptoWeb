        ...
        <div id="TickContainer">
          <table width="100%">
             <tr>
              ...
              <tr>
                  <td colspan="2" align="right" id="timeDate"><?php echo $date; ?>
                  </td>
              </tr>
          </table>
      </div>
    ...
    <div class="row">
        <div class="col-md-10">
            <div class="panel panel-default">
                <div class="panel-heading"><h2 class="panel-title">This is the Heading of the pannel</h2></div>
                    <div class="panel-body">
                        This is some of the content that is in the website
                    </div>
                    <table class="table">
                        <tr>
                            <th>Heading 1</th>
                ...
                <div class="panel-footer">This is the footer for credits/tags/and author info
                </div>
            </div>
        </div>
    </div>
